	...
	public sealed class Subscription
	{
		...
		public void Add(ChannelEntity channelEntity, bool reset)
		{
			...
			else
			{
				...
				IDictionary<string, object> userState = channelEntitiesDictionary[channelEntity.ChannelID].UserState;
				if (userState == null)
				{
		...
		public IDictionary<string, object> EditUserState(IDictionary<string, object> newUserState,
			IDictionary<string, object> oldUserState, bool edit)
		{
		...
		public bool UpdateOrAddUserStateOfEntity(ref ChannelEntity channelEntity, IDictionary<string, object> userState, bool edit)
		{
