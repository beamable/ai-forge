...
namespace PubNubMessaging.Core
{
	public class BuildRequests
	{
		...
		private static StringBuilder ParameterStringBuilder
		{
			get
			{
		...
		internal static string BuildRegisterDevicePushRequest(string channel, PushTypeService pushType,
			string pushToken, string uuid,
			bool ssl, string origin, string authenticationKey, string subscribeKey)
		{
			StringBuilder parameterBuilder = ParameterStringBuilder;
		...
		internal static string BuildRemoveChannelPushRequest(string channel, PushTypeService pushType,
			string pushToken, string uuid,
			bool ssl, string origin, string authenticationKey, string subscribeKey)
		{
			StringBuilder parameterBuilder = ParameterStringBuilder;
		...
		internal static string BuildGetChannelsPushRequest(PushTypeService pushType, string pushToken, string uuid,
			bool ssl, string origin, string authenticationKey, string subscribeKey)
		{
			StringBuilder parameterBuilder = ParameterStringBuilder;
		...
		internal static string BuildUnregisterDevicePushRequest(PushTypeService pushType, string pushToken, string uuid,
			bool ssl, string origin, string authenticationKey, string subscribeKey)
		{
			StringBuilder parameterBuilder = ParameterStringBuilder;
		...
		internal static string BuildPublishRequest(string channel, string message, bool storeInHistory, string uuid,
		...
		internal static string BuildDetailedHistoryRequest(string channel, long start, long end,
		...
		internal static string BuildHereNowRequest(string channel, string channelGroups, bool showUUIDList, bool includeUserState, string uuid,
			bool ssl, string origin, string authenticationKey, string subscribeKey)
		{
		...
		internal static string BuildGlobalHereNowRequest(bool showUUIDList, bool includeUserState, string uuid,
			bool ssl, string origin, string authenticationKey, string subscribeKey)
		{
			int disableUUID = (showUUIDList) ? 0 : 1;
			int userState = (includeUserState) ? 1 : 0;
		...
		internal static string BuildWhereNowRequest(string uuid, string sessionUUID,
			bool ssl, string origin, string authenticationKey, string subscribeKey)
		{
			List<string> url = new List<string>();
		...
		internal static string BuildTimeRequest(string uuid, bool ssl, string origin)
		{
			List<string> url = new List<string>();
		...
		internal static string BuildGrantAccessRequest(string channel, bool read, bool write, int ttl, string uuid,
			bool ssl, string origin, string authenticationKey,
		...
		internal static string BuildAuditAccessRequest(string channel, string uuid,
			bool ssl, string origin, string authenticationKey,
			string publishKey, string subscribeKey, string cipherKey, string secretKey)
		{
			string signature = "0";
		...
		internal static string BuildSetUserStateRequest(string channel, string channelGroup, string jsonUserState, string uuid, string sessionUUID,
			bool ssl, string origin, string authenticationKey, string subscribeKey)
		{
			StringBuilder paramBuilder = ParameterStringBuilder;
		...
		internal static string BuildGetUserStateRequest(string channel, string channelGroup, string uuid, string sessionUUID,
			bool ssl, string origin, string authenticationKey, string subscribeKey)
		{
			string parameters = "";
			if (!string.IsNullOrEmpty(channelGroup) && channelGroup.Trim().Length > 0)
		...
		internal static string BuildPresenceHeartbeatRequest(string channels, string channelGroups, string channelsJsonState, string uuid,
			bool ssl, string origin, string authenticationKey, string subscribeKey)
		{
			StringBuilder presenceParamBuilder = ParameterStringBuilder;
		...
		internal static string BuildMultiChannelSubscribeRequestV2(string channels, string channelGroups, string timetoken,
		...
		{
			StringBuilder subscribeParamBuilder = ParameterStringBuilder;
		...
		internal static string BuildAddChannelsToChannelGroupRequest(string[] channels, string nameSpace, string groupName, string uuid,
			bool ssl, string origin, string authenticationKey, string subscribeKey)
		{
		...
		internal static string BuildRemoveChannelsFromChannelGroupRequest(string[] channels, string nameSpace, string groupName, string uuid,
			bool ssl, string origin, string authenticationKey, string subscribeKey)
		{
		...
		internal static string BuildGetChannelsForChannelGroupRequest(string nameSpace, string groupName, bool limitToChannelGroupScopeOnly,
		...
		internal static string BuildChannelGroupAuditAccessRequest(string channelGroup, string uuid,
			bool ssl, string origin, string authenticationKey,
			string publishKey, string subscribeKey, string cipherKey, string secretKey)
		{
			string signature = "0";
		...
		internal static string BuildChannelGroupGrantAccessRequest(string channelGroup, bool read, bool write, bool manage, int ttl, string uuid,
			bool ssl, string origin, string authenticationKey,
			string publishKey, string subscribeKey, string cipherKey, string secretKey)
		{
			string signature = "0";
		...
		{
			get { return SharedStringBuilder.Builder; }
		}

		private static string BuildRestApiRequest<T>(List<string> urlComponents, ResponseType type, string uuid, bool ssl, string origin,
			int pubnubPresenceHeartbeatInSeconds, string authenticationKey, string parameters)
		{
			StringBuilder url = UrlStringBuilder;
